    ...
    <div class="row">
        ...
        <div class="col-12 col-xl-6 offset-xl-1 mt-4">
            ...
            <div class="row block block-rounded block-fx-shadow p-3">
                <h1 class="mb-4">Contrats de services - en nombre d'intervention</h1>
                    ...
                    <form @submit.prevent="goNext()" id="infos_company" method="POST" accept-charset="UTF-8" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <p class="mb-1">
                                    Quel est le nombre d’interventions sur lequel vous vous êtes engagé ?
                                </p>
                                <div class="mb-5">
                                    <inputformgroup :infos_input='{
                                        "name" : "engagement_nb_intervention",
                                        "text" : "Nombre d`interventions",
                                        "type" : "text",
                                        "required" : true,
                                        "value" : currentDataEkoUsage.data_eko.engagement_nb_intervention,
                                        "placeholder" : "Le nombre d`interventions (ex: 4 ...)"}' />
                                </div>

                                <p class="mb-1">
                                    A combien d’interventions avant le terme souhaiterez-vous être informé de la fin de contrat qui approche ?
                                </p>
                                <div class="mb-5">
                                    <inputformgroup :infos_input='{
                                        "name" : "reminder_nb_intervention",
                                        "text" : "Nombre d`interventions avant la fin de l`engagement",
                                        "type" : "text",
                                        "required" : true,
                                        "value" : currentDataEkoUsage.data_eko.reminder_nb_intervention,
                                        "placeholder" : "La nombre d`interventions avant la fin de l`engagement (ex: 6 ...)"}' />
                                </div>
...
<script>
    export default {
        ...
        created(){
            this.$store.dispatch('setStep','contract-intervention');
        },
        computed:{
        },
        methods: {
            goNext: function() {
                ...
                ekousage.data_eko.engagement_nb_intervention = $('#engagement_nb_intervention').val();
                ekousage.data_eko.reminder_nb_intervention = $('#reminder_nb_intervention').val();
